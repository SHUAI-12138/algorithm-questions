...
public class Solution {
    ...
    // if(p2 >= len2) return nums2[p1 + K -1];
    // return nums1[p1] <= nums2[p2] ? nums1[p1] : nums2[p2];
    // }
    // if(p1 >= len1) return (nums2[p2 + K -1] + nums2[p2 + K]) / 2.0;
    // if(p2 >= len2) return (nums1[p1 + K -1] + nums1[p1 + K]) / 2.0;
    // int sum = 0;
    // for(int i = 0; i < 2; i++) {
    ...
    // p2++;
    // }
    // if(p1 == len1) return (sum + nums2[p2]) / 2.0;
    // if(p2 == len2) return (sum + nums1[p1]) / 2.0;
    // }
    // return sum / 2.0;
    // }
}
